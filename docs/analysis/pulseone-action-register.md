...
Each action is tagged with a **Priority** (P1 = Immediate / P2 = Urgent / P3 = Strategic), an estimated **Profit Recovery** opportunity, the **Owner** responsible, and the **Status** of execution. Actions are grouped by the BiC evaluation domain they address. As actions are completed, update the Status column and record the outcome.

---

## 1. Software Resale Pricing & Revenue Mapping
...
## 3. Service Utilization & Billing Efficiency
...
| UTL-07 | Audit total logged hours across all ConnectWise boards to ensure time entry compliance | P2 | TBD | Jim | NOT STARTED | Utilization Findings |
...
## 5. Revenue Quality & Client Strategy (Structural)
...
## 6. Financial Reporting & Chart of Accounts (Foundational)
...
## 7. ConnectWise Data Requests (Blocking Items)

These are specific data pulls required to unblock multiple action items above.
...
| CW-07 | Ticket type breakdown by board | UTL-02, UTL-07 | P2 | Jim | NOT STARTED |
| CW-08 | Billing code write-down detail | UTL-01 | P2 | Jim | NOT STARTED |
| CW-09 | Hours-by-client report for client profitability ranking | REV-06 | P2 | Jim | NOT STARTED |
