...
## A. Objective
This document provides a complete, cross-departmental breakdown of PulseOne's business performance for CY 2025. It synthesizes all financial, operational, labor, and sales data into a single unified model, explicitly highlighting where PulseOne aligns with Service Leadership Best in Class (BiC) benchmarks, where structural gaps exist, and the specific open items required to resolve remaining unknowns.

This breakdown incorporates all owner-confirmed corrections, including the removal of non-operating entities (RepScheduler/POC), the treatment of partner compensation at Fair Market Value, and the updated resource allocations for the W-2 and contractor workforce [1] [2].

---

## B. Executive Financial Summary

PulseOne is a highly capable managed services engine whose core profitability is currently obscured by three distinct, fixable structural issues: underpriced project delivery, an imbalanced sales/marketing model, and unmanaged software resale pass-throughs.
...
## D. Departmental Breakdown: Sales & Marketing

The Sales & Marketing department is structurally imbalanced, heavily funding closing capacity while starving the lead generation engine [6].

*   **S&M Spend:** $358,844 (6.9% of revenue)
*   **BiC Target:** 5.4% of revenue
*   **BiC Gap Analysis:** PulseOne spent $5.80 on closing capacity and marketing overhead for every $1 spent on actual lead generation ($52K Advertising & Promotion). 
*   **Pipeline Failure:** The sales team ($234K in capacity) generated 0% self-sourced pipeline, relying entirely on the $52K ad spend. BiC standard requires sales to self-source 30–50% of their pipeline [6].
*   **Revenue Optics:** The apparent 16.2% decline in Managed Services revenue is a reporting artifact caused by the mid-year consolidation of 10 Bunzl subsidiaries into a single corporate billing entity, not a massive churn event [6].

### Open Items & Clarifications (Sales & Marketing)
1.  **Bunzl Revenue Neutrality:** A side-by-side comparison of total monthly billing for all Bunzl entities in Q1 2025 versus the consolidated Bunzl corporate billing in Q4 2025 to ensure no revenue was lost in the transition.
2.  **CAC Verification:** A list of net-new Managed Services agreements signed in CY 2025 to calculate the true Customer Acquisition Cost against the $52K ad spend.

---

## E. Departmental Breakdown: General & Administrative (SaaS Tools)

The G&A overhead gap is driven more by misclassification than by actual excessive spending [7].

*   **Internal SG&A Software Spend:** $1,743 per employee
*   **BiC Target:** $4,830 to $10,050 per employee
*   **BiC Gap Analysis:** PulseOne's true internal software spend is highly efficient (**EXCEEDS BiC**). The perceived "tool sprawl" was largely caused by $194,092 in Service Delivery tools (ConnectWise, Flexis, Kaseya) being misclassified as SG&A in QuickBooks. 
...
## F. Summary of Prioritized Next Steps
...
[3] `audit-profit-waterfall-2025.md`
[4] `pulseone-segment-pl-2025.md`
[5] `PulseOne_Technician_Scheduling_and_Utilization_Audit.md`
[6] `audit-marketing-investment.md`
[7] `audit-saas-tool-sprawl.md`
