# PulseOne Profitability Remediation Plan (May 2026)
...
## C. Phase 1: Immediate Structural Cuts (Committed)

The following actions have been committed and represent the immediate restructuring of the delivery and operational overhead.

### 1. W-2 Furloughs and Reductions ($7,984/month savings)
To right-size the W-2 labor pool against current demand without eliminating core capabilities, the following furloughs (pay reductions) are implemented immediately:
- Kaitlin Harris: 20% reduction ($1,134/mo)
- Stephen Calkins: 20% reduction ($2,120/mo)
- Nicole Goodwin: 20% reduction ($1,531/mo)
- Laura Walsh: 10% reduction ($1,010/mo)
...
- **Dare Olusanjo:** Eliminated entirely ($4,333/mo)
- **Charlesdoone Castro:** Eliminated entirely ($2,716/mo)
- **Vincent Williams:** Reduced by 20% ($1,750/mo)
- **Matt Barnett:** Reduced by 20% ($1,493/mo)
- **Jeremy Roe:** Transitioned to a 10-hour/week retainer for project COGS only ($6,261/mo savings)
*Note: AJ and Blaine (My IT Svcs) are retained at $13,000/mo to handle the dedicated Bunzl Help Desk volume.*

### 3. Partner Compensation Reduction ($9,000/month savings)
...
## E. Phase 3: The 90-Day Evaluation (August 2026)

The remaining gap to the $30,000 net cash target relies heavily on the performance of the Sales department, which currently costs $43,085/month (14.5% of revenue, vs. BiC target of 3-4%).

### 1. Sales Performance Gates
The recent investment in Hinkley ($10,000/mo) and four new sales reps ($8,000/mo) must demonstrate ROI by August 2026.
- **Target:** The sales team must generate enough new monthly recurring revenue (MRR) to cover their $18,000/month cost burden, plus margin.
- **Decision:** If measurable pipeline and closed MRR do not justify the investment by August 31, the $18,000/month expansion will be reversed. This action alone would close the remainder of the net cash gap.

### 2. Project Delivery Viability
- **Target:** Project invoicing must consistently hit $52,000/month to achieve EBITDA breakeven for the consulting division, given the heavy W-2 coordination costs (Walsh, Harris).
- **Decision:** If project revenue remains at the $20,000-$30,000 level, the division is structurally non-viable. The remaining outsourced project labor (Vincent, Jeremy, Matt) must be eliminated, and PulseOne must transition to a pure Managed Services model, utilizing only existing W-2 staff for minimal project delivery.

---

## F. Capacity Assurance

A key risk of the Phase 1 cuts is whether the remaining Help Desk team can support the ticket volume.

**Demand Analysis:**
- Current average demand: ~629 tickets/month
- Less departing clients (ARC, Conejo, Sea Ranch): -39 tickets
- Adjusted Demand: **~590 tickets/month**

**Supply Analysis:**
- Capacity lost (Dare, Charlesdoone): 193 tickets/month
